  ...
  return (
    ...
    >
      ...
      <DialogContent>
        ...
        <p>The group that brought you <strong>Material Design Icons</strong> over the years have formed an open-source collective. You can learn all about it on our <Link href='/docs/general/about'>about</Link> page.</p>
