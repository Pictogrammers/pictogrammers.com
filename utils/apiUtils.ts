...
export const getContributors = async ({
  ...
  try {
    ...
    return {
      contributors: randomize ? getRandomArrayValues(filteredContributors, returnAmount) : filteredContributors,
