...
```
https://cdn.jsdelivr.net/npm/@mdi/font@{{version:mdi}}/css/materialdesignicons.min.css
```
...
The above files are also on the CDN: [View Latest](https://www.jsdelivr.com/package/npm/@mdi/font@{{version:mdi}}).
