...
Although [using the webfont is generally not recommended](/docs/guides/webfont-alternatives/) for performance reasons, you can easily use it (or Iconify) in your Ember app.
