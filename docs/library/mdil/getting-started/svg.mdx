...
description: Material Design Icon Light icons are SVGs, so they are the preferred way to consume the icons.
icon: mdi:svg
---
...
For users of NPM, we provide all the icons as SVG files in the `@mdi/light-svg` package.
