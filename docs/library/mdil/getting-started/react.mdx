...
description: Material Design Icons Light can be used in React with our first-party module.
icon: si:react
---

Material Design Icons Light can be used in React with our first-party `@mdi/react` module.
...
```jsx
<p><Icon path={mdilAccount} /> User Profile</p>
<p><Icon path={mdilAccount} title="User Profile" /></p>
<button aria-label="User Profile"><Icon path={mdilAccount} /></button>
```
