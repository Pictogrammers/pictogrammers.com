...
:Button[Install for Visual Studio Code]{href='https://marketplace.visualstudio.com/items?itemName=lukas-tr.materialdesignicons-intellisense' startIcon=mdi:microsoft-visual-studio-code variant=contained}
