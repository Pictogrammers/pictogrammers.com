...
description: Material Design Icons can be used in React with a custom component or with the one provided in this module.
...
:Button[Demo]{href='https://templarian.github.io/@mdi/react/' startIcon=mdi:human-male-board variant=outlined}
:Button[MaterialDesign-React on GitHub]{href='https://github.com/Templarian/MaterialDesign-React' startIcon=mdi:github variant=outlined}
:Button[VS Code Extension]{href='https://marketplace.visualstudio.com/items?itemName=lukas-tr.materialdesignicons-intellisense' startIcon=mdi:microsoft-visual-studio-code variant=outlined}
...
:Button[View Example App on CodeSandbox]{href='https://codesandbox.io/s/staging-paper-5w879' startIcon=mdi:open-in-new variant=outlined}
