...
If you'd like to use Material Design Icons in your Android app, there are two options: Using SVGs or Using a Library.
...
![Demo animation of implementation](https://i.imgur.com/KXHfXo8.gif)
