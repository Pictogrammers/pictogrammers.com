...
:Button[View the Changelog]{href='/mdi/changelog' startIcon=mdi:text-box-outline variant=outlined}
:Button[View the Upgrade Guide]{href='/mdi/upgrade' startIcon=mdi:format-list-checks variant=outlined}
