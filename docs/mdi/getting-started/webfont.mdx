...
<Button href='/mdi/changelog' startIcon='mdi:text-box-outline'>View the Changelog</Button>
<Button href='/mdi/upgrade' startIcon='mdi:format-list-checks'>View the Upgrade Guide</Button>
