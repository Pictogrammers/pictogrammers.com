...
:Button[Learn More (Webfont - Getting Started)]{href='./webfont' startIcon=mdi:language-html5 variant=outlined}
...
:Button[Learn More (SVG - Getting Started)]{href='./svg' startIcon=mdi:svg variant=outlined}
