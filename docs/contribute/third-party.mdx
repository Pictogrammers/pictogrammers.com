...
While Pictogrammers supports several [first party](/docs/guides/first-party) libraries, utilities, and components, our core team leaves a lot of the integrations up to the third-party community.
...
- [`@mdi/font-build`](https://www.npmjs.com/package/@mdi/font-build)
  - This is what builds the webfont! (`@mdi/svg` and `@mdi/light-svg` contain `font-build.json` for this reason).
...
- [MaterialDesignLight](https://github.com/Pictogrammers/MaterialDesignLight) - Main Repo Synced Real-time
