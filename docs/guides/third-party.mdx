...
|------------------|--------------|
| :Icon{icon=mdi:close color=red} Scraping the website for data | :Icon{icon=mdi:check color=green} Let us know through an issue if `meta.json` is missing anything. |
| :Icon{icon=mdi:close color=red} Expecting us to add icons since you use the project | :Icon{icon=mdi:check color=green} We recommend projects to be built to support multiple icon packs and not to rely entirely on ours. |
