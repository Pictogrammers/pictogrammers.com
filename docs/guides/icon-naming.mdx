...
<Tabs>
  <Tab title='Bold'>
    ![bold](/images/docs/grid-96-bold.svg)
  </Tab>
  <Tab title='thick'>
    ![thick](/images/docs/grid-96-thick.svg)
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title='Box'>
    ![box](/images/docs/grid-96-box.svg)
  </Tab>
  <Tab title='Circle'>
    ![circle](/images/docs/grid-96-circle.svg)
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title='Plus'>
    ...
    ![plus](/images/docs/grid-96-plus-bottom-right.svg)
  </Tab>
  <Tab title='Minus'>
    The minus modifier can be appended to any noun icon.

    ![minus](/images/docs/grid-96-minus-bottom-right.svg)
  </Tab>
  <Tab title='Remove'>
    The remove modifier can be appended to any noun icon.

    ![remove](/images/docs/grid-96-remove-bottom-right.svg)
  </Tab>
  <Tab title='Check'>
    The check modifier can be appended to any noun icon.

    ![check](/images/docs/grid-96-check.svg)
  </Tab>
</Tabs>
...
<Tabs>
  <Tab title='Variant'>
    ...
    ![variant](/images/docs/grid-96-variant.svg)
  </Tab>
  <Tab title='Multiple'>
    ![multiple](/images/docs/grid-96-multiple.svg)
  </Tab>
  <Tab title='Off'>
    ![off](/images/docs/grid-96-off.svg)
  </Tab>
  <Tab title='Outline'>
    2dp outline of an existing filled icon.

    ![outline](/images/docs/grid-96-outline.svg)
  </Tab>
</Tabs>
