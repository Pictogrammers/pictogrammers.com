...
const LIBRARIES = [
  ...
  },
  {
    ...
    description:
      'Taking a lighter spin on Google’s Material Design guidelines, MDL slims down icons to be modern, crisp, and clean.',
...
export default class Home extends LightningElement {
  ...
  renderedCallback() {
    this.template
      .querySelector('pg-header')
      .addEventListener('scroll_to', this.scrollTo.bind(this));
    this.template
      .querySelector('pg-hero')
      .addEventListener('scroll_to', this.scrollTo.bind(this));
  ...
  disconnectedCallback() {
    this.template
      .querySelector('pg-header')
      .removeEventListener('scroll_to', this.scrollTo.bind(this));
    this.template
      .querySelector('pg-hero')
      .removeEventListener('scroll_to', this.scrollTo.bind(this));
  }
  ...
  scrollTo(event) {
    this.template
      .querySelector(`[data-location="${event.detail.location}"]`)
