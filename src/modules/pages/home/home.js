...
export default class Home extends LightningElement {
  ...
  scrollTo(event) {
    this.template.querySelector(`[data-location="${event.detail.location}"]`)?.scrollIntoView({ behavior: 'smooth' });
  }
}
